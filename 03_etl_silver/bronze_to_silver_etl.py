...
BRONZE_PATH = "s3://tech-challenge-aws-data-hackers/bronze/"
SILVER_PATH = "s3://tech-challenge-aws-data-hackers/silver/state_of_data/"
...
STANDARD_SCHEMA = [
    ...
    "nivel_senioridade", "faixa_salarial", "tempo_experiencia_dados",
    "modelo_trabalho_atual", "usa_ia_generativa_trabalho",
    "linguagens_utilizadas", "cloud_utilizada",
]
...
MAP_2023_BY_CODE = {
    ...
    "P1_l": "nivel_ensino",
    "P2_f": "cargo_atual",
    "P2_g": "nivel_senioridade",
    "P2_h": "faixa_salarial",
    "P2_i": "tempo_experiencia_dados",
    "P4_m": "usa_ia_generativa_trabalho",
    "P4_d": "linguagens_utilizadas",
    "P4_h": "cloud_utilizada",
...
MAP_2024_BY_NAME = {
    ...
    "4.m_usa_chatgpt_ou_copilot_no_trabalho?": "usa_ia_generativa_trabalho",
    "4.d_linguagem_de_programacao_(dia_a_dia)": "linguagens_utilizadas",
    "4.h_cloud_(dia_a_dia)": "cloud_utilizada",
}
...
MAP_2025_BY_NAME = {
    ...
    "4.j_usa_chatgpt_ou_copilot_no_trabalho?": "usa_ia_generativa_trabalho",
    "4.c_linguagem_preferida": "linguagens_utilizadas",
    "4.e_cloud_(dia_a_dia)": "cloud_utilizada",
}
